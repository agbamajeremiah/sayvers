                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php 
                                            ...
                                            if(@$this->session->flashdata('invalid_reg')){
                                                echo '<div class="alert alert-danger">'.$this->session->flashdata('invalid_reg').'</div>';
                                            }
                                        ?>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputPhoneNumber" type="text" name="phone" placeholder="+2349011111111" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputConfirmPassword" type="password" name="confirmpwd" placeholder="Confirm password" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="<?php echo site_url('auth/login') ?>">Have an account? login instead</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
